...
public void tambahTransaksi(){
    ...
    private void lanjutkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lanjutkanActionPerformed
        // TODO add your handling code here:
          try {
            String sql = "INSERT INTO penjualan VALUES ('" + txNoTransaksi.getText() + "','" 
                    + txtanggal.getText() + "','" + txpelanggan.getText() + "','" + btnbayar.getText() + "')";
        ...
        try {
            ...
            for (int i = 0; i < baris; i++) {
                String sql = "INSERT INTO penjualanrinci(NoFaktur, id_pelanggan, jenis_ikan, jumlah, harga, total) VALUES('"+ txNoTransaksi.getText() +"','"
